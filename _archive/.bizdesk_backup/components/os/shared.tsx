...
// ── Shared Types ────────────────────────────────────────────────────────────
export type OsTab = 'home' | 'company' | 'banking' | 'gst' | 'experts' | 'records' | 'global' | 'networking' | 'bharat-support' | 'market-access' | 'user-profile' | 'settings' | 'sell-commerce' | 'suppliers' | 'retailer' | 'learn' | 'launchpad';
