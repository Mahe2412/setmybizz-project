...
// ── Shared Types ────────────────────────────────────────────────────────────
export type OsTab = 'home' | 'company' | 'banking' | 'sales' | 'billbook' | 'billease' | 'orderdesk' | 'gst' | 'experts' | 'records' | 'global' | 'networking' | 'bharat-support' | 'market-access' | 'user-profile' | 'settings' | 'sell-commerce' | 'suppliers' | 'retailer' | 'learn' | 'launchpad' | 'spotlight' | 'workflows' | 'crm' | 'google' | 'operations' | 'workforce';
